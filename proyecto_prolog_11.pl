...
%CON PARAMETROS VALIDOS:
%createScene(10,12,_,_,_,S_OUT).

%CON PARAMETROS INVALIDOS:
%createScene(_,_,3,_,_,S_OUT).

%CON SEED:
%createScene(_,_,_,_,48747388483309,S_OUT).

/* CHECKSCENE */

%ESCENARIO VALIDO:
%checkScene([5,10,12,[1,[1,1,3]],[2,[1,1,9],[1,1,10]]]).

%ESCENARIO INVALIDO POR PERSONAJES EXTERIORES:
%checkScene([5,10,12,[1,[1,1,3]],[2,[1,1,15],[1,1,10]]]).

%ESCENARIO INVALIDO POR PERSONAJES SUPERPUESTOS:
%checkScene([5,10,12,[1,[1,1,3]],[2,[1,1,3],[1,1,10]]]).

/* MOVEMEMBER */

%MOVIMIENTO A LA IZQUIERDA:
%movemember([5,10,12,[1,[1,1,3]],[2,[1,1,3],[1,1,10]]],1,i,_,S_OUT).

%MOVIMIENTO A LA DERECHA:
%movemember([5,10,12,[1,[1,1,3]],[2,[1,1,3],[1,1,10]]],1,d,_,S_OUT).

%MOVIMIENTO INVALIDO, FUERA DEL MAPA:
%movemember([5,10,12,[1,[1,1,1]],[2,[1,1,3],[1,1,10]]],1,i,_,S_OUT).

%MOVIMIENTO INVALIDO, SOBRE OTRO PERSONAJE:
%moveMember([5,10,12,[1,[1,1,2]],[2,[1,1,3],[1,1,10]]],1,d,_,S).
